...
```bash
git clone https://github.com/ThienPhu04/Eatate_App.git
...
Appwrite Database Setup can be found [here](https://cloud.appwrite.io/console/project-fra-682d785500223aae0a6a/overview/platforms)
